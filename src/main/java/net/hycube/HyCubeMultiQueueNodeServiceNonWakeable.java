...
public class HyCubeMultiQueueNodeServiceNonWakeable extends MultiQueueNodeServiceNonWakeable implements HyCubeNodeService {

//	private static org.apache.commons.logging.Log userLog = LogHelper.getUserLog();
//	private static org.apache.commons.logging.Log devLog = LogHelper.getDevLog(HyCubeMultiQueueNodeServiceNonWakeable.class); 
	

	public static HyCubeMultiQueueNodeServiceNonWakeable initializeFromConf(Environment environment, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static HyCubeMultiQueueNodeServiceNonWakeable initializeFromConf(Environment environment, String nodeIdString, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static HyCubeMultiQueueNodeServiceNonWakeable initializeFromConf(String nodeServiceConfKey, Environment environment, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	protected static HyCubeMultiQueueNodeServiceNonWakeable initializeFromConf(String nodeServiceConfKey, HyCubeMultiQueueNodeServiceNonWakeable nodeService, Environment environment, NodeId nodeId, String nodeIdString, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
		if (nodeService == null) {
			nodeService = new HyCubeMultiQueueNodeServiceNonWakeable();
		}
		return (HyCubeMultiQueueNodeServiceNonWakeable) MultiQueueNodeServiceNonWakeable.initializeFromConf(nodeServiceConfKey, nodeService, environment, nodeId, nodeIdString, networkAddress, bootstrapNodeAddress, joinCallback, callbackArg, errorCallback, errorCallbackArg);
	}
	...
	public static HyCubeMultiQueueNodeServiceNonWakeable initialize(Environment environment, NodeId nodeId, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventQueueProcessingInfoNonWakeable[] eventQueuesProcessingInfo, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static HyCubeMultiQueueNodeServiceNonWakeable initialize(Environment environment, String nodeIdString, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventQueueProcessingInfoNonWakeable[] eventQueuesProcessingInfo, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	protected static HyCubeMultiQueueNodeServiceNonWakeable initialize(HyCubeMultiQueueNodeServiceNonWakeable nodeService, Environment environment, NodeId nodeId, String nodeIdString, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventQueueProcessingInfoNonWakeable[] eventQueuesProcessingInfo, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
		if (nodeService == null) {
			nodeService = new HyCubeMultiQueueNodeServiceNonWakeable();
		}
		return (HyCubeMultiQueueNodeServiceNonWakeable) MultiQueueNodeServiceNonWakeable.initialize(nodeService, environment, nodeId, nodeIdString, networkAddress, bootstrapNodeAddress, joinCallback, callbackArg, eventQueuesProcessingInfo, errorCallback, errorCallbackArg);
	}
