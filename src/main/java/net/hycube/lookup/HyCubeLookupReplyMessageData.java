...
public class HyCubeLookupReplyMessageData {
	...
	protected int calculateLookupReplyMessageDataLength(int nodeIdDimensions, int nodeIdDigitsCount) {
		int dataLength =
	...
	protected HyCubeLookupReplyMessageData() {
		
	}
	
	public HyCubeLookupReplyMessageData(int lookupId, HyCubeLookupNextHopSelectionParameters parameters, byte[][] networkAddresses, HyCubeNodeId[] nodeIds) {
	...
	public HyCubeLookupReplyMessageData(int lookupId, HyCubeLookupNextHopSelectionParameters parameters, NodePointer[] nodePointers) {
	...
	public byte[] getBytes(int nodeIdDimensions, int nodeIdDigitsCount) {
		...
		ByteBuffer b = ByteBuffer.allocate(calculateLookupReplyMessageDataLength(nodeIdDimensions, nodeIdDigitsCount));
	...
	public static HyCubeLookupReplyMessageData fromBytes(byte[] bytes, int nodeIdDimensions, int nodeIdDigitsCount, int networkAddressByteLength) throws MessageByteConversionException {
		
		HyCubeLookupReplyMessageData lookupReplyMsg = new HyCubeLookupReplyMessageData();
		...
		try {
			...
			lookupReplyMsg.setLookupId(lookupId);
			...
			lookupReplyMsg.parameters = parameters;
			...
			lookupReplyMsg.networkAddresses = networkAddresses;
			lookupReplyMsg.nodeIds = nodeIds;
		...
		if (lookupReplyMsg.calculateLookupReplyMessageDataLength(nodeIdDimensions, nodeIdDigitsCount) != bytes.length) {
			throw new MessageByteConversionException("The length of the byte array passed to the method is not equal to the expected message data length.");
		}
		
		return lookupReplyMsg;
