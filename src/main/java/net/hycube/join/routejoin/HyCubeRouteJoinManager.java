...
public class HyCubeRouteJoinManager implements JoinManager {
	...
	protected HashMap<Integer, HyCubeRouteJoinData> joinsData;
	...
	public void initialize(NodeAccessor nodeAccessor, NodeProperties properties) throws InitializationException {
		...
		joinsData = new HashMap<Integer, HyCubeRouteJoinData>(HashMapUtils.getHashMapCapacityForElementsNum(GlobalConstants.INITIAL_JOINS_DATA_COLLECTION_SIZE, GlobalConstants.DEFAULT_HASH_MAP_LOAD_FACTOR), GlobalConstants.DEFAULT_HASH_MAP_LOAD_FACTOR);
