...
public class HyCubeSearchJoinRequestTimeoutEvent extends Event {
	...
	public HyCubeSearchJoinRequestTimeoutEvent(HyCubeSearchJoinManager joinManager, ProcessEventProxy eventProxy, int joinId, String nodeAddressString, long nodeIdHash, boolean initialRequest, boolean finalSearch) {
