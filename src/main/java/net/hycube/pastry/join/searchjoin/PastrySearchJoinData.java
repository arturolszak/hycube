...
public class PastrySearchJoinData {
	...
	public PastrySearchJoinData(int joinId, String[] bootstrapNodeAddresses, short alpha, short beta, short gamma, boolean secureSearch, boolean skipRandomNextHops) {
