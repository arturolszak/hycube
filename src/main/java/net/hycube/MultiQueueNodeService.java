...
public abstract class MultiQueueNodeService implements NodeService {

	private static org.apache.commons.logging.Log userLog = LogHelper.getUserLog();
	private static org.apache.commons.logging.Log devLog = LogHelper.getDevLog(MultiQueueNodeService.class); 
	...
	protected List<WakeableManager> wakeableManagersList;
	...
	public static MultiQueueNodeService initializeFromConf(Environment environment, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static MultiQueueNodeService initializeFromConf(Environment environment, NodeId nodeId, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static MultiQueueNodeService initializeFromConf(Environment environment, String nodeIdString, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static MultiQueueNodeService initializeFromConf(String nodeServiceConfKey, Environment environment, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	protected static MultiQueueNodeService initializeFromConf(String nodeServiceConfKey, MultiQueueNodeService nodeService, Environment environment, NodeId nodeId, String nodeIdString, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
		...
		try {
			...
			for (int queueIndex = 0; queueIndex < queueKeys.size(); queueIndex++) {
				...
				NodeProperties threadPoolProperties = nodeServiceProperties.getNestedProperty(PROP_KEY_THREAD_POOL, queueKeys.get(queueIndex).toString());
	...
	public static MultiQueueNodeService initialize(Environment environment, NodeId nodeId, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventQueueProcessingInfo[] eventQueuesProcessingInfo, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static MultiQueueNodeService initialize(Environment environment, String nodeIdString, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventQueueProcessingInfo[] eventQueuesProcessingInfo, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	protected static MultiQueueNodeService initialize(MultiQueueNodeService nodeService, Environment environment, NodeId nodeId, String nodeIdString, String networkAddress, String bootstrapNodeAddress, JoinCallback joinCallback, Object callbackArg, EventQueueProcessingInfo[] eventQueuesProcessingInfo, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
		...
		nodeService.wakeableManagers = new HashMap<EventType, WakeableManager>();
		nodeService.notifyingQueuesList = new ArrayList<NotifyingLinkedBlockingQueue<Event>>();
		nodeService.wakeableManagersList = new ArrayList<WakeableManager>();
		for (EventQueueProcessingInfo eqpi : eventQueuesProcessingInfo) {
			...
			if (eqpi.getWakeable()) {
				...
				nodeService.wakeableManagersList.add(wakeableManager);
			...
			for (EventType et : eqpi.getEventTypes()) {
				...
				nodeService.wakeableManagers.put(et, wakeableManager);
		...
		eventProcessor.initialize((BlockingQueue<Event>[])(queues.toArray(new BlockingQueue[0])), (ThreadPoolInfo[])(threadPoolInfos.toArray(new ThreadPoolInfo[0])), errorCallback, errorCallbackArg);
		...
		try {
			messageReceiver.initialize(environment, (NotifyingBlockingQueue<Event>) nodeService.eventQueues.get(receiveMessageEventType), nodeService.wakeableManagers.get(receiveMessageEventType), messageReceiverProperties);
...
//		}
	...
	public void discard() {
		...
		for (WakeableManager wm : wakeableManagersList) {
			wm.discard();
		}
		...
		this.wakeableManagersList = null;
