...
public class HyCubeRefreshPutMessageData {
	...
	protected HyCubeRefreshPutMessageData() {
		
	}
	
	public HyCubeRefreshPutMessageData(int commandId, BigInteger key, String resourceDescriptorString, long refreshTime) {
	...
	public static HyCubeRefreshPutMessageData fromBytes(byte[] bytes) throws MessageByteConversionException {
		
		HyCubeRefreshPutMessageData msgData = new HyCubeRefreshPutMessageData();
