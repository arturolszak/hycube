...
public abstract class SchedulingMultipleNodeService extends AbstractMultipleNodeService {
	...
	private static org.apache.commons.logging.Log devLog = LogHelper.getDevLog(SchedulingMultipleNodeService.class); 
	
		
	
	public static SchedulingMultipleNodeService initializeFromConf(Environment environment, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static SchedulingMultipleNodeService initializeFromConf(Environment environment, int initialNodeProxyServicesCollectionsSize, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
		return initializeFromConf(null, null, environment, initialNodeProxyServicesCollectionsSize, errorCallback, errorCallbackArg);
	}
	
	public static SchedulingMultipleNodeService initializeFromConf(String nodeServiceConfKey, Environment environment, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static SchedulingMultipleNodeService initializeFromConf(String nodeServiceConfKey, Environment environment, int initialNodeProxyServicesCollectionsSize, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	protected static SchedulingMultipleNodeService initializeFromConf(String nodeServiceConfKey, SchedulingMultipleNodeService nodeService, Environment environment, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	protected static SchedulingMultipleNodeService initializeFromConf(String nodeServiceConfKey, SchedulingMultipleNodeService nodeService, Environment environment, int initialNodeProxyServicesCollectionsSize, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static SchedulingMultipleNodeService initialize(Environment environment, EventQueueProcessingInfo[] eventQueuesProcessingInfo, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	public static SchedulingMultipleNodeService initialize(Environment environment, EventQueueProcessingInfo[] eventQueuesProcessingInfo, int initialNodeProxyServicesCollectionsSize, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	protected static SchedulingMultipleNodeService initialize(SchedulingMultipleNodeService multiNodeService, Environment environment, EventQueueProcessingInfo[] eventQueuesProcessingInfo, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
	...
	protected static SchedulingMultipleNodeService initialize(SchedulingMultipleNodeService multiNodeService, Environment environment, EventQueueProcessingInfo[] eventQueuesProcessingInfo, int initialNodeProxyServicesCollectionsSize, EventProcessingErrorCallback errorCallback, Object errorCallbackArg) throws InitializationException {
		...
		eventProcessor.initialize(environment, (BlockingQueue<Event>[])queues.toArray(new BlockingQueue<?>[queues.size()]), eventQueuesProcessingInfo, errorCallback, errorCallbackArg);
		multiNodeService.eventProcessor = eventProcessor;
		
		
		//event scheduler
		
		multiNodeService.eventScheduler = eventProcessor;
